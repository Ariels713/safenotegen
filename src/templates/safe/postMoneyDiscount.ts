...
export const postMoneyDiscountTemplate: DocumentTemplate = {
	...
	sections: [
		{
			title: '1. Events',
			content: `(a) Equity Financing. If there is an Equity Financing before the termination of this Safe, on the initial closing of such Equity Financing, this Safe will automatically convert into the number of shares of Standard Preferred Stock equal to the Purchase Amount divided by the Discount Price.
...
(e) Termination. This Safe will automatically terminate (without relieving the Company of any obligations arising from a prior breach of or non-compliance with this Safe) immediately following the earliest to occur of: (i) the issuance of Capital Stock to the Investor pursuant to the automatic conversion of this Safe under Section 1(a); or (ii) the payment, or setting aside for payment, of amounts due the Investor pursuant to Section 1(b) or Section 1(c).`
		...
		{
			title: '2. Discount',
			content: 'The price per share of the shares of preferred stock sold in the Qualified Financing will be the price per share of the preferred stock sold in the Qualified Financing multiplied by the Discount Rate.'
		},
		{
			title: '3. Definitions',
