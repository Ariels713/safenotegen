...
export const generateProRataLetter = async (
  state: SafeFormState
): Promise<Blob> => {
        ...
        children: [
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: '") is entered into on or about ',
              }),
              new TextRun({
                text: state.investorInfo.investDate || "[Date of Safe]",
              }),
              new TextRun({
                text: " in connection with the purchase by ",
              }),
              new TextRun({
              ...
              new TextRun({
                text: '") of that certain simple agreement for future equity with a "Post-Money Valuation Cap" (the "',
              }),
              new TextRun({
                text: "Investor's Safe",
                bold: true,
              }),
              new TextRun({
                text: '") issued by ',
              ...
              new TextRun({
                text: "\") on or about the date of this Agreement.  As a material inducement to the Investor's investment, the Company agrees to the provisions set forth in this Agreement.  Capitalized terms used herein shall have the meanings set forth in the Investor's Safe.",
              }),
            ],
            spacing: {
              after: 400,
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: 'The Investor shall have the right to purchase its pro rata share of Standard Preferred Stock being sold in the Equity Financing (the "',
              }),
              new TextRun({
                text: "Pro Rata Right",
                bold: true,
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `Name: ${
                  state.companyInfo.authorizedSignatoryName || "[name]"
                }`,
              }),
            ],
            spacing: {
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `Title: ${
                  state.companyInfo.authorizedSignatoryTitle || "[title]"
                }`,
              }),
            ],
            spacing: {
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `Name: ${
                  state.investorInfo.authorizedSignatoryName || "[name]"
                }`,
              }),
            ],
            spacing: {
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `Title: ${
                  state.investorInfo.authorizedSignatoryTitle || "[title]"
                }`,
              }),
            ],
            spacing: {
