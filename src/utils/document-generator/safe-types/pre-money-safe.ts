...
export const generatePreMoneySafe = async (state: SafeFormState): Promise<Blob> => {
		...
		sections: [{
			...
			children: [
				...
				new Paragraph({
					children: [
						new TextRun({
							text: `The "Valuation Cap" is $${state.valuationCap || '[_____________]'}.  See Section 2 for certain additional defined terms.`
						})
					],
					spacing: {
						after: 400
				...
				new Paragraph({
					children: [
						...
						new TextRun({
							text: 'If there is an Equity Financing before the expiration or termination of this instrument, the Company will automatically issue to the Investor either: (1) a number of shares of Standard Preferred Stock equal to the Purchase Amount divided by the price per share of the Standard Preferred Stock, if the pre-money valuation is less than or equal to the Valuation Cap; or (2) a number of shares of Safe Preferred Stock equal to the Purchase Amount divided by the Safe Price, if the pre-money valuation is greater than the Valuation Cap.'
						})
					],
					spacing: {
						after: 400
				...
				new Paragraph({
					children: [
						new TextRun({
							text: 'In connection with the issuance of Standard Preferred Stock or Safe Preferred Stock, as applicable, by the Company to the Investor pursuant to this Section 1(a):'
						})
					],
					spacing: {
						after: 400
				...
				new Paragraph({
					children: [
						new TextRun({
							text: '"Company Capitalization" means the sum, as of immediately prior to the Equity Financing, of: (1) all shares of Capital Stock (on an as-converted basis) issued and outstanding, assuming exercise or conversion of all outstanding vested and unvested options, warrants and other convertible securities, but excluding (A) this instrument, (B) all other Safes, and (C) convertible promissory notes; and (2) all shares of Common Stock reserved and available for future grant under any equity incentive or similar plan of the Company, and/or any equity incentive or similar plan to be created or increased in connection with the Equity Financing.'
						})
					],
					spacing: {
						after: 400
				...
				new Paragraph({
					children: [
						new TextRun({
							text: '"Liquidity Capitalization" means the number, as of immediately prior to the Liquidity Event, of shares of Capital Stock (on an as-converted basis) outstanding, assuming exercise or conversion of all outstanding vested and unvested options, warrants and other convertible securities, but excluding: (i) shares of Common Stock reserved and available for future grant under any equity incentive or similar plan; (ii) this instrument; (iii) other Safes; and (iv) convertible promissory notes.'
						})
					],
					spacing: {
						after: 400
				...
				new Paragraph({
					children: [
						new TextRun({
							text: '"Liquidity Price" means the price per share equal to the Valuation Cap divided by the Liquidity Capitalization.'
						})
					],
					spacing: {
						after: 400
				...
				new Paragraph({
					children: [
						new TextRun({
							text: '"Safe Price" means the price per share equal to the Valuation Cap divided by the Company Capitalization.'
						})
					],
					spacing: {
						after: 400
