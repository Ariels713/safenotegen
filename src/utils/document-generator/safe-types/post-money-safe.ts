        ...
        children: [
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: `") on or about ${
                  state.investorInfo.investDate || "_________________"
                }, ${state.companyInfo.legalName || "_________________"}, a ${
                  state.companyInfo.stateOfIncorporation || "_________________"
                } corporation (the "`,
              }),
              new TextRun({
                text: "Company",
              ...
              new TextRun({
                text: `"), issues to the Investor the right to certain shares of the Company's Capital Stock, subject to the terms set forth below.`,
              }),
            ],
            spacing: {
              after: 200,
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: 'If there is a Liquidity Event before the termination of this Safe, the Investor will automatically be entitled (subject to the liquidation priority set forth in Section 1(d) below) to receive a portion of Proceeds, due and payable to the Investor immediately prior to, or concurrent with, the consummation of such Liquidity Event, equal to the greater of (i) the Purchase Amount (the "',
              }),
              new TextRun({
              ...
              new TextRun({
                text: '") or (ii) the amount payable on the number of shares of Common Stock equal to the Purchase Amount divided by the Liquidity Price (the "',
              }),
              new TextRun({
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: '" is calculated as of immediately prior to the Equity Financing and (without double-counting, in each case calculated on an as-converted to Common Stock basis):',
              }),
            ],
            spacing: {
              after: 200,
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: 'Converting Securities"',
                bold: true,
              }),
              new TextRun({
                text: " includes this Safe and other convertible securities issued by the Company, including but not limited to: (i) other Safes; (ii) convertible promissory notes and other convertible debt instruments; and (iii) convertible securities that have the right to convert into shares of Capital Stock.  ",
              }),
            ],
            spacing: {
              after: 200,
          ...
          // Dissolution Event definition (inserted after Direct Listing)
          new Paragraph({
            children: [
              new TextRun({
                text: '"',
          ...
          // Equity Financing definition (inserted after Dividend Amount)
          new Paragraph({
            children: [
              new TextRun({
                text: '"',
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: '" is calculated as of immediately prior to the Liquidity Event, and (without double-counting, in each case calculated on an as-converted to Common Stock basis):',
              }),
            ],
            spacing: {
              after: 200,
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: ' any Safes and other convertible securities (including without limitation shares of Preferred Stock) where the holders of such securities are receiving Cash-Out Amounts or similar liquidation preference payments in lieu of Conversion Amounts or similar "as-converted" payments; and',
              }),
            ],
            indent: {
              left: 720,
          ...
          // Liquidity Event definition (insert before Liquidity Price)
          new Paragraph({
            children: [
              new TextRun({
                text: '"',
          ...
          // Liquidity Price definition (insert after Liquidity Event)
          new Paragraph({
            children: [
              new TextRun({
                text: '"',
              ...
              new TextRun({
                text: '" means the price per share equal to the Post-Money Valuation Cap divided by the Liquidity Capitalization.',
              }),
            ],
            spacing: {
              after: 200,
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: '" includes options, restricted stock awards or purchases, RSUs, SARs, warrants or similar securities, vested or unvested.',
              }),
            ],
            spacing: {
              after: 200,
          ...
          // Proceeds definition (insert after Options)
          new Paragraph({
            children: [
              new TextRun({
                text: '"',
          ...
          // Safe definition (insert before Safe Preferred Stock)
          new Paragraph({
            children: [
              new TextRun({
                text: '"',
		...
		new Paragraph({
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: "Unissued Option Pool",
                bold: true,
              }),
              new TextRun({
                text: '" means all shares of Capital Stock that are reserved, available for future grant and not subject to any outstanding Options or Promised Options (but in the case of a Liquidity Event, only to the extent Proceeds are payable on such Promised Options) under any equity incentive or similar Company plan.',
              }),
            ],
            spacing: {
              after: 200,
          ...
          new Paragraph({
            children: [
              ...
              new TextRun({
                text: `All rights and obligations hereunder will be governed by the laws of the State of ${
                  state.companyInfo.stateOfGovernance || "_________________"
