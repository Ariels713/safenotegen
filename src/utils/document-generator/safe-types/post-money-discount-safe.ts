...
export const generatePostMoneyDiscountSafe = async (state: SafeFormState): Promise<Blob> => {
		...
		sections: [{
			...
			children: [
				...
				new Paragraph({
					children: [
						new TextRun({
							text: `The "Discount Rate" is ${100 - (state.discount || 0)}%.  See Section 2 for certain additional defined terms.`
						})
					],
					spacing: {
						after: 400
				...
				new Paragraph({
					children: [
						...
						new TextRun({
							text: 'If there is an Equity Financing before the termination of this Safe, on the initial closing of such Equity Financing, this Safe will automatically convert into the number of shares of Safe Preferred Stock equal to the Purchase Amount divided by the Discount Price.'
						})
					],
					spacing: {
						after: 400
				...
				new Paragraph({
					children: [
						new TextRun({
							text: '"Discount Price" means the lowest price per share of the Standard Preferred Stock sold in the Equity Financing multiplied by the Discount Rate.'
						})
					],
					spacing: {
						after: 400
				...
				new Paragraph({
					children: [
						new TextRun({
							text: '"Equity Financing" means a bona fide transaction or series of transactions with the principal purpose of raising capital, pursuant to which the Company issues and sells Preferred Stock at a fixed valuation, including but not limited to, a pre-money or post-money valuation.'
						})
					],
					spacing: {
						after: 400
				...
				new Paragraph({
					children: [
						new TextRun({
							text: '"Liquidity Event" means a Change of Control, a Direct Listing or an Initial Public Offering.'
						})
					],
					spacing: {
						after: 400
				...
				new Paragraph({
					children: [
						new TextRun({
							text: '"Proceeds" means cash and other assets (including without limitation stock consideration) that are proceeds from the Liquidity Event or the Dissolution Event, as applicable, and legally available for distribution.'
						})
					],
					spacing: {
						after: 400
				...
				new Paragraph({
					children: [
						new TextRun({
							text: '"Safe" means an instrument containing a future right to shares of Capital Stock, similar in form and content to this instrument, purchased by investors for the purpose of funding the Company\'s business operations. References to "this Safe" mean this specific instrument.'
						})
					],
					spacing: {
						after: 400
