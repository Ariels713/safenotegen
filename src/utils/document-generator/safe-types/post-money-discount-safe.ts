					...
					default: new Header({
						children: [
							new Paragraph({
								children: [
									new TextRun({
										text: "Post-Money SAFE - Discount Only",
				...
				children: [
					...
					new Paragraph({
						children: [
							...
							new TextRun({
								text: '" means the lowest price per share of the Standard Preferred Stock sold in the Equity Financing multiplied by the Discount Rate.',
							}),
						],
						spacing: {
							after: 200,
