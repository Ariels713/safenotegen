...
export const generatePreMoneyMfnSafe = async (state: SafeFormState): Promise<Blob> => {
			...
			children: [
				...
				new Paragraph({
					children: [
						...
						new TextRun({
							text: "If there is an Equity Financing before the expiration or termination of this instrument, the Company will automatically issue to the Investor a number of shares of Preferred Stock sold in the Equity Financing equal to the Purchase Amount divided by the price per share of the Preferred Stock.",
						}),
					],
					spacing: {
						after: 200,
				...
				new Paragraph({
					children: [
						new TextRun({
							text: "In connection with the issuance of such shares of Preferred Stock to the Investor pursuant to this Section 1(a):",
						}),
					],
					spacing: {
						after: 200,
