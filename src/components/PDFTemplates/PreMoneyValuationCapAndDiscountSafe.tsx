	...
	return (
		<Document>
			<Page size="A4" style={styles.page}>
				...
				<View style={styles.section}>
					<Text>
						The &ldquo;<Text style={styles.bold}>Valuation Cap</Text>&rdquo; is ${state.valuationCap?.toLocaleString() || "[VALUATION CAP]"}.
					</Text>
					<Text>
						The &ldquo;<Text style={styles.bold}>Discount Rate</Text>&rdquo; is {state.discount ? (100 - state.discount) : "[DISCOUNT]"}%.
					</Text>
					<Text>
				...
				<View style={styles.definitionList}>
					...
					<Text style={styles.definitionItem}>
						<Text style={styles.bold}>&ldquo;Conversion Price&rdquo; </Text>
						means the either: (1) the Safe Price or (2) the Discount Price, whichever calculation results in a greater number of shares of Safe Preferred Stock.
					</Text>

					<Text style={styles.definitionItem}>
						<Text style={styles.bold}>&ldquo;Discount Price&rdquo; </Text>
						means the price per share of the Standard Preferred Stock sold in the Equity Financing multiplied by the Discount Rate.
					</Text>
