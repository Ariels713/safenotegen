...
interface PreMoneyDiscountSafeProps {
	state: SafeFormState
}

export default function PreMoneyDiscountSafe({ state }: PreMoneyDiscountSafeProps) {
	return (
		<Document>
			<Page size="A4" style={styles.page}>
				...
				<View style={styles.section}>
					<Text>
						The &ldquo;<Text style={styles.bold}>Discount Rate</Text>&rdquo; is {state.discount}%. See <Text style={styles.bold}>Section 2</Text> for certain additional defined terms.
					</Text>
				</View>
				...
				<View style={styles.definitionList}>
					...
					<Text style={styles.definitionItem}>
						...
						means the lowest price per share of the Standard Preferred Stock sold in the Equity Financing multiplied by the Discount Rate.
					</Text>
					...
					<Text style={styles.definitionItem}>
						...
						means the price per share equal to the fair market value of the Common Stock at the time of the Liquidity Event, as determined by reference to the purchase price payable in connection with such Liquidity Event, multiplied by the Discount Rate.
					</Text>
