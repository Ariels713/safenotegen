...
interface PostMoneyMfnSafeProps {
	state: SafeFormState
}

export default function PostMoneyMfnSafe({ state }: PostMoneyMfnSafeProps) {
	return (
		<Document>
			<Page size="A4" style={styles.page}>
				...
				<View style={styles.section}>
					<Text>
						This Post-Money SAFE includes a Most Favored Nation (MFN) provision. The MFN provision means that if the Company issues any SAFE with terms more favorable to the holder than those in this SAFE, the Company will notify the Investor and the Investor will have the right to exchange this SAFE for a new SAFE with such more favorable terms.
					</Text>
				</View>

				<View style={styles.section}>
					<Text>
						See <Text style={styles.bold}>Section 2</Text> for certain additional defined terms.
					</Text>
				</View>
				...
				<View style={styles.section}>
					<Text>
						...
						If there is an Equity Financing before the termination of this Safe, on the initial closing of such Equity Financing, this Safe will automatically convert into the number of shares of Standard Preferred Stock equal to the Purchase Amount divided by the lowest price per share of the Standard Preferred Stock.
					</Text>
				</View>
				...
				<View style={styles.section}>
					<Text>
						...
						If there is a Liquidity Event before the termination of this Safe, the Investor will automatically be entitled (subject to the liquidation priority set forth in Section 1(d) below and the &ldquo;MFN&rdquo; Amendment Provision in Section 3 below) to receive a portion of Proceeds, due and payable to the Investor immediately prior to, or concurrent with, the consummation of such Liquidity Event, equal to the Purchase Amount (the &ldquo;<Text style={styles.bold}>Cash-Out Amount</Text>&rdquo;).
					</Text>
				</View>
				...
				<View style={styles.definitionList}>
					...
					<Text style={styles.definitionItem}>
						...
						means the price per share equal to the fair market value of the Common Stock at the time of the Liquidity Event, as determined by reference to the purchase price payable in connection with such Liquidity Event.
					</Text>
					...
					<Text style={styles.definitionItem}>
						<Text style={styles.bold}>&ldquo;Subsequent Convertible Securities&rdquo; </Text>
				...
				<View style={styles.section}>
					<Text style={[styles.bold, styles.italic]}>5. Investor Representations</Text>
				</View>
				...
				<View style={styles.section}>
					<Text style={[styles.bold, styles.italic]}>6. Miscellaneous</Text>
				</View>
